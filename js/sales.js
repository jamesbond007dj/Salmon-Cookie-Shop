...
function Sales (locations1, maxCustomer1, minCustomer1, aveSale1) {
  this.locations1 = locations1;
  this.maxCustomer1 = maxCustomer1;
  this.minCustomer1 = minCustomer1;
  this.aveSale1 = aveSale1;
  this.TotalSales1 = [];
...
function formData (event) {
  ...
  var locations1 = event.target.locations1.value;
  var maxCustomer1 = event.target.maxCustomer1.value;
  var minCustomer1 = event.target.minCustomer1.value;
  var aveSale1 = event.target.aveSale1.value;
  
  data.push(new formData(locations1, maxCustomer1, minCustomer1, aveSale1));
...
function createTable () {
  ...
  for (var t = 0 ; t < data.length; t++) {
    ...
    row.innerHTML = '<td>' + data[t].locations1 + '</td>' + 
        '<td>' + data[t].maxCustomer1 + '</td>' + 
        '<td>' + data[t].minCustomer1 + '</td>' +
        '<td>' + data[t].aveSale1 + '</td>'
  }
